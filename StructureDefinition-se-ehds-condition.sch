...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'https://fhir.inera.se/StructureDefinition/ext-asserted-date']) &lt;= 1">extension with URL = 'https://fhir.inera.se/StructureDefinition/ext-asserted-date': maximum cardinality of 'extension' is 1</sch:assert>
