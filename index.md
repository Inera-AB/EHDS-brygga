...
```json
{
  ...
  "id" : "se.ehds.brygga",
  "language" : "sv",
  "url" : "https://fhir.inera.se/ImplementationGuide/se.ehds.brygga",
  "version" : "0.1.0",
  "name" : "SEEHDSBrygga",
  "title" : "SE EHDS Brygga Implementation Guide",
  "status" : "draft",
  ...
  "description" : "Implementation Guide för EHDS-bryggan. Definierar FHIR-profiler och mappningar för konvertering av Ineras RIVTA-tjänstekontrakt till FHIR R4.\n",
  "jurisdiction" : [{
    "coding" : [{
  ...
  {
    "id" : "hl7se_fhir_base",
    "uri" : "http://hl7.se/fhir/ig/base/ImplementationGuide/hl7se.fhir.base",
    "packageId" : "hl7se.fhir.base",
    "version" : "1.1.0"
  }],
  "definition" : {
    "extension" : [{
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/ext-asserted-date"
      },
      "name" : "Asserted Date",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/DiagnosisTypeCS"
      },
      "name" : "Diagnos Typ (kv_diagnostyp)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ConceptMap/DiagnosisTypeToCategoryMap"
      },
      "name" : "DiagnosisType → Condition.category",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsForskrivarkod"
      },
      "name" : "Förskrivarkod (Socialstyrelsen)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsHospYrken"
      },
      "name" : "HOSP-yrken (Socialstyrelsen)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsHsaIdBasprofil"
      },
      "name" : "HSA-id (HL7 Sweden basprofiler)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsHsaIdInera"
      },
      "name" : "HSA-id (Inera NTjP/RIVTA)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsIcd10International"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsIcd10Se"
      },
      "name" : "ICD-10-SE",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsKva"
      },
      "name" : "KVÅ – Klassifikation av vårdåtgärder",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsLegitimationsnummer"
      },
      "name" : "Legitimationsnummer (Socialstyrelsen)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsPersonnummer"
      },
      "name" : "Personnummer",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsSamordningsnummer"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/SEDiagnosisType"
      },
      "name" : "SE Diagnos Typ",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/se-ehds-condition"
      },
      "name" : "SE EHDS Condition",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/se-ehds-document-reference"
      },
      "name" : "SE EHDS DocumentReference",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/se-ehds-patient"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Patient/SEEHDSPatientExample"
      },
      "name" : "SE EHDS Patient Example",
      "description" : "Minimalt exempel på en patient som uppfyller SEEHDSPatient-profilen.",
      "exampleCanonical" : "https://fhir.inera.se/StructureDefinition/se-ehds-patient"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "NamingSystem/NsSnomedCt"
      },
      "name" : "SNOMED CT",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "NamingSystem/NsSosnyk"
      },
      "name" : "SOSNYK – yrkeskategorier (Socialstyrelsen)",
    ...
    "page" : {
      ...
      },
      {
        ...
        "title" : "Mappning: GetDiagnosis → Condition",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "mapping-getdocumentlist.html"
        }],
        "nameUrl" : "mapping-getdocumentlist.html",
        "title" : "Mappning: GetDocumentList → DocumentReference",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "naming-systems.html"
        }],
        "nameUrl" : "naming-systems.html",
        "title" : "OID-till-URI-mappningar",
        "generation" : "markdown"
      },
      {
        "extension" : [{
